...
module design_1_OV7675_capture_0_0(clk, reset_n, pclk, vs, hs, data_in, xclk, data_out, 
  bram_addr, bram_we, bram_en, pen, pdn, Red, Green, Blue)
/* synthesis syn_black_box black_box_pad_pin="reset_n,vs,hs,data_in[7:0],xclk,data_out[31:0],bram_addr[31:0],bram_we[3:0],bram_en,pen,pdn,Red[7:0],Green[7:0],Blue[7:0]" */
