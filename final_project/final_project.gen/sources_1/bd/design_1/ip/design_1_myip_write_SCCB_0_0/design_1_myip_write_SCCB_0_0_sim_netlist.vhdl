...
entity design_1_myip_write_SCCB_0_0_write_SCCB is
  port (
    sio_c : out STD_LOGIC;
    sio_d : out STD_LOGIC;
...
architecture STRUCTURE of design_1_myip_write_SCCB_0_0_write_SCCB is
  ...
  signal data_to_SCCB_saved : STD_LOGIC_VECTOR ( 17 downto 1 );
  ...
  signal sio_d1_out : STD_LOGIC;
  signal sio_d_i_10_n_0 : STD_LOGIC;
  ...
  signal sio_d_reg_i_5_n_0 : STD_LOGIC;
  signal state : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal tick_200k_i_1_n_0 : STD_LOGIC;
  signal tick_200k_i_2_n_0 : STD_LOGIC;
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "idle:000,trx_start1:001,trx_start2:010,trx_high:100,trx_end2:110,trx_end3:111,trx_low:011,trx_end1:101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "idle:000,trx_start1:001,trx_start2:010,trx_high:100,trx_end2:110,trx_end3:111,trx_low:011,trx_end1:101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "idle:000,trx_start1:001,trx_start2:010,trx_high:100,trx_end2:110,trx_end3:111,trx_low:011,trx_end1:101";
  ...
  attribute SOFT_HLUTNM of \timer[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \timer[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \timer[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \timer[5]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \timer[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \timer[8]_i_1\ : label is "soft_lutpair2";
begin
  sio_c <= \^sio_c\;
  sio_d <= \^sio_d\;
...
\data_count[31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000200"
    )
        port map (
...
\data_count[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00820000"
    )
        port map (
...
\data_count_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => s00_axi_aclk,
      CE => \data_count[31]_i_2_n_0\,
      D => \data_count[0]_i_1_n_0\,
      Q => \data_count_reg_n_0_[0]\,
      R => \data_count[31]_i_1_n_0\
    );
...
\data_count_reg[1]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
\data_count_reg[3]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
\data_count_reg[4]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '1'
    )
        port map (
...
\data_to_SCCB_saved[17]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00200000"
    )
        port map (
...
sio_c_i_1: unisim.vcomponents.LUT6
    generic map(
...
sio_d_i_10: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => data_to_SCCB_saved(15),
      I1 => data_to_SCCB_saved(14),
      I2 => \data_count_reg_n_0_[1]\,
      I3 => data_to_SCCB_saved(13),
      I4 => \data_count_reg_n_0_[0]\,
      I5 => data_to_SCCB_saved(12),
      O => sio_d_i_10_n_0
    );
sio_d_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFE200E200000000"
        ...
        port map (
      I0 => sio_d_reg_i_4_n_0,
      I1 => \data_count_reg_n_0_[3]\,
      I2 => sio_d_reg_i_5_n_0,
      I3 => \data_count_reg_n_0_[4]\,
      I4 => sio_d_i_6_n_0,
      I5 => state(1),
      O => sio_d_i_2_n_0
    );
sio_d_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A8AA0000"
    )
        port map (
...
sio_d_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000AAAA0505FEAE"
    )
        port map (
      I0 => \data_count_reg_n_0_[3]\,
      I1 => data_to_SCCB_saved(16),
      I2 => \data_count_reg_n_0_[0]\,
      I3 => data_to_SCCB_saved(17),
      I4 => \data_count_reg_n_0_[1]\,
      I5 => \data_count_reg_n_0_[2]\,
      O => sio_d_i_6_n_0
    );
sio_d_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFA0CFCF"
    )
        port map (
      I0 => data_to_SCCB_saved(3),
      I1 => data_to_SCCB_saved(2),
      I2 => \data_count_reg_n_0_[1]\,
      I3 => data_to_SCCB_saved(1),
      I4 => \data_count_reg_n_0_[0]\,
      O => sio_d_i_7_n_0
    );
sio_d_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => data_to_SCCB_saved(7),
      I1 => data_to_SCCB_saved(6),
      I2 => \data_count_reg_n_0_[1]\,
      I3 => data_to_SCCB_saved(5),
      I4 => \data_count_reg_n_0_[0]\,
      I5 => data_to_SCCB_saved(4),
      O => sio_d_i_8_n_0
    );
sio_d_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFAFCFC0"
    )
        port map (
      I0 => data_to_SCCB_saved(11),
      I1 => data_to_SCCB_saved(10),
      I2 => \data_count_reg_n_0_[1]\,
      I3 => data_to_SCCB_saved(8),
      I4 => \data_count_reg_n_0_[0]\,
      O => sio_d_i_9_n_0
    );
...
sio_d_reg_i_5: unisim.vcomponents.MUXF7
     port map (
      I0 => sio_d_i_9_n_0,
      I1 => sio_d_i_10_n_0,
      O => sio_d_reg_i_5_n_0,
...
tick_200k_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000FFFF80000000"
    )
        port map (
      I0 => timer(7),
      I1 => tick_200k_i_2_n_0,
      I2 => timer(6),
      I3 => timer(8),
      I4 => reset_n,
      I5 => tick_200k_reg_n_0,
      O => tick_200k_i_1_n_0
    );
tick_200k_i_2: unisim.vcomponents.LUT6
    generic map(
...
\timer[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_myip_write_SCCB_0_0_myip_write_SCCB_slave_lite_v1_0_S00_AXI is
  port (
...
write_SCCB_inst: entity work.design_1_myip_write_SCCB_0_0_write_SCCB
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_myip_write_SCCB_0_0_myip_write_SCCB is
  port (
...
begin
myip_write_SCCB_slave_lite_v1_0_S00_AXI_inst: entity work.design_1_myip_write_SCCB_0_0_myip_write_SCCB_slave_lite_v1_0_S00_AXI
     port map (
...
entity design_1_myip_write_SCCB_0_0 is
  ...
  attribute NotValidForBitStream of design_1_myip_write_SCCB_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_myip_write_SCCB_0_0 : entity is "design_1_myip_write_SCCB_0_0,myip_write_SCCB,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_myip_write_SCCB_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_myip_write_SCCB_0_0 : entity is "myip_write_SCCB,Vivado 2024.2";
end design_1_myip_write_SCCB_0_0;

architecture STRUCTURE of design_1_myip_write_SCCB_0_0 is
...
U0: entity work.design_1_myip_write_SCCB_0_0_myip_write_SCCB
     port map (
