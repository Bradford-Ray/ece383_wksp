...
#
# Script generated by Vivado on Wed Apr 29 11:45:33 -0600 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/C27Bradford.Hurt/ece383_wksp/final_project/final_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
