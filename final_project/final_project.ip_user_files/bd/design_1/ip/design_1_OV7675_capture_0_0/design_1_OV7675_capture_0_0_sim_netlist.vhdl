...
architecture STRUCTURE of design_1_OV7675_capture_0_0_OV7675_capture is
  ...
  signal \line_count[8]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \line_count[8]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \line_count[8]_i_4\ : label is "soft_lutpair3";
...
\line_count[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \line_count_reg_n_0_[3]\,
      I4 => \line_count[8]_i_4_n_0\,
      I5 => \line_count_reg_n_0_[8]\,
      O => line_count(8)
    );
\line_count[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\line_count[8]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
