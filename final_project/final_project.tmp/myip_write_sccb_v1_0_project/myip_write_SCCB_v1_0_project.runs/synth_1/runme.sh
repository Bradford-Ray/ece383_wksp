...
HD_PWD='c:/users/c27bradford.hurt/ece383_wksp/final_project/final_project.tmp/myip_write_sccb_v1_0_project/myip_write_SCCB_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_write_SCCB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_write_SCCB.tcl
