...
HD_PWD='C:/Users/C27Bradford.Hurt/ece383_wksp/final_project/final_project.runs/design_1_dvid_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dvid_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dvid_0_1.tcl
