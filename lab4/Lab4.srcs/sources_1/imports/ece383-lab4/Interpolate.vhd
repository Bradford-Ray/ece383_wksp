...
begin
    ...
    delta_x_offset <= (signed_next - signed_base) * signed_offset; -- TODO: Compute the delta*offset; -- (Q16.0 - Q16.0) * Q1.8 = Q17.8
    base_plus_delta_x_offset <= signed_base + delta_x_offset(data_size-2 downto frac_bits); -- TODO: Compute the base + delta*offset to get the interpolated value; -- Q16.0 + [Q17.8 sliced to Q16.0]
