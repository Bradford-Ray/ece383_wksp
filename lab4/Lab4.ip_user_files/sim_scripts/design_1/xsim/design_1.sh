...
#
# Script generated by Vivado on Mon Apr 06 08:14:00 -0600 2026
...
simulate()
{
  xsim design_1 -key {Behavioral:Lab4_dp:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
